...
This registry is AdLauncher-specific: every evidence path below (`architecture/tech-debt.md`, `src/launch/PRD/PRD.md`, etc.) is relative to `01_brain/02_CONTEXT/AdLauncher/`.
