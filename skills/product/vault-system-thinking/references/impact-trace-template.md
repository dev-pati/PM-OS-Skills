...
Paths in this template (`src/<feature>/`, `architecture/tech-debt.md`, `product/backlog.md`) are relative to the active project's root, `Second Brain/projects/<project>/`.
